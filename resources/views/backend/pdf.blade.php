                            ...
                            <div class="inbox-widget">
                                @foreach($jskills as $jskill)
                                    <div class="inbox-item">
                                        ...
                                        <div class="progress mb-0" style="background: red!important;border: 2px solid red;">
                                            <div class="progress-bar" role="progressbar" style="width: {{ $jskill->progress }}%;background: red!important;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{{ $jskill->progress }}%</div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
